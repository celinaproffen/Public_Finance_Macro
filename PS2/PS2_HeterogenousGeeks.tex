...
\end{equation*}
With this we can estimate the age income profile and replace the normalized age profile in the code with the corresponding estimates. Please refer to $\texttt{towards\_olg.m}$ for the estimates of age profile. \\
