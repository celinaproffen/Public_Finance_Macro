...
a) Table \ref{tab:totcons-deltacons} \input{PS2/reg_totcons_deltacons} \\
% \input{PS2/reg_food_deltacons}
% \input{PS2/reg_ndcons1_deltacons}
% \input{PS2/reg_ndcons2_deltacons}
% \input{PS2/reg_ndconsserv_deltacons}


b) Table \ref{tab:totcons-deltainc}
\input{PS2/reg_totcons_deltainc}
% \input{PS2/reg_food_deltainc}
% \input{PS2/reg_ndcons1_deltainc}
% \input{PS2/reg_ndcons2_deltainc}
% \input{PS2/reg_ndconsserv_deltainc}
