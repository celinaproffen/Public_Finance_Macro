...
In the attached PDF (Comparison model outcomes) I plotted all required scenarios in a way that (hopefully) allows an easier comparison. I have classified the models as follows, whereby the red coloured part identifies the deviations from the standard model:
