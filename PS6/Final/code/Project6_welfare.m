...
disp('Calculating rules under GENERAL EQ')
    ...
    EV_GE = EQIV(V_gen_orig,V_gen_altern);
    ...
    disp(['Equivalent variation in PE: ', num2str(EV_PE)]);
    ...
    disp(['Equivalent variation in GE: ', num2str(EV_GE)]);
end
