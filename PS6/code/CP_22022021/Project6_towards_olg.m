...
function [fval,ass,Y] = func_olg(ret)
    ...
    %wag = func_firm(mpk); % marginal product of labor that depends on capital
...
function [aggregate_cap_supply] = towards_olg(wage_scaling_factor)
...
% calibration
func_calibr(opt_det,opt_nosr,opt_ny,wage_scaling_factor);
...
% ++++++++++++++++++++++++++++++++++++++++++++++++++++++
function func_calibr(opt_det,opt_nosr,opt_ny,wage_scaling_factor)
