...
\begin{equation*}
    \eta_1=\frac{2exp(1-\simga_{ln\eta})}{exp(1-\simga_{ln\eta})+exp(1+\simga_{ln\eta})}\approx\frac{2exp(1-0.95)}{exp(1-0.95)+exp(1+0.95)}\approx 0.26
    \end{equation*}
    \begin{equation*}
       \eta_{11}=\frac{2exp(1+\simga_{ln\eta})}{exp(1-\simga_{ln\eta})+exp(1+\simga_{ln\eta})}\approx\frac{2exp(1+0.95)}{exp(1-0.95)+exp(1+0.95)}\approx 1.73
    \end{equation*}
